...
<section class="cases-main parent parent-overflow parent-best">
    ...
    <div class="cases-main__sidebar">
        <div class="cases-main__sidebar__wrap">
            <div class="cases-main__sidebar__wrap__info">
                <span class="cases-main__sidebar__wrap__info__title"><?php echo esc_html(get_field('sidebar_form_title')) ?></span>
                <span
                    class="cases-main__sidebar__wrap__info__subtitle"><?php echo esc_html(get_field('sidebar_form_subtitle')) ?></span>
            </div>
    ...
    <div class="container">
        <div class="cases-main__box">
            <div class="cases-main__content">
                <?php echo wp_kses_post(get_sub_field('content_zone')); ?>
            </div>
        </div>
    </div>
    <?php endif; ?>
                ...
                <div class="work-scope">
                    ...
                    <div class="work-scope__list">
                        <div class="work-scope__list__title">
                            <span><?php echo esc_html(get_sub_field('work_scope_title')); ?></span>
                        </div>
                        <div class="work-scope__list__percent">
                            <div class="work-scope__list__percent--line"
                                style="width: calc(<?php echo esc_html(get_sub_field('work_scope_percent')); ?>% - var(--fly))"></div>
                        </div>
                        <div class="work-scope__list__hour">
                            <span> <?php echo esc_html(get_sub_field('work_scope_title_hour')); ?></span>
                        </div>
                    </div>
                    <?php endwhile; endif; ?>
                </div>
            ...
            <div class="cases-main__content">
                ...
                <div class="grid-content <?php echo $order; ?>">
                    ...
                    <div class="grid-content__simple">
                        <?php echo wp_kses_post(get_sub_field('simple_content_g')); ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="grid-content__list-lo">
                        ...
                        <div class="grid-content__list-lo__item">
                            <p><?php echo esc_html(get_sub_field('title_r_g')); ?></p>
    ...
    <div class="result <?php echo $bg_color; ?>">
        <span><?php echo esc_html(get_sub_field('result_title_zone')); ?></span>
        <p><?php echo esc_html(get_sub_field('result_desc_zone')); ?></p>
    </div>
    <?php endif; ?>

    <?php if (get_row_layout() == 'coment_zone_lay') : ?>
    <div class="coment <?php echo $bg_color; ?>">
        <p><?php echo esc_html(get_sub_field('coment_desc_zone')); ?></p>
        <span><?php echo esc_html(get_sub_field('coment_name_zone')); ?></span>
        ...
        <div class="coment__bott">
            <div class="coment__rating">
                <span><?php echo esc_html(get_sub_field('coment_rating_numb_zone')); ?></span>
                <div class="star">
            ...
            <div class="coment__reviews">
                <span><?php echo esc_html(get_sub_field('coment_reviews_zone')); ?></span>
            </div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="cases-main__q-img">
        ...
        <p><?php echo esc_html(get_sub_field('q_text')); ?></p>
    </div>
    <?php endif; ?>
    ...
    <div class="cases-main__figure">
        ...
        <div class="cases-main__figure__bg-lines bg-<?php echo esc_html(get_sub_field('figure_select')); ?>">
            <div class="flying <?php echo esc_html(get_sub_field('figure_select')); ?>"></div>
        </div>
        <?php endwhile; endif; ?>
    </div>
</section>