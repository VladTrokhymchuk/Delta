...
<section>
    <div class="container">
        <h1>test ekonom</h1><br>
        <?php  
        
        echo do_shortcode( '[contact-form-7 id="1301" title="Економ-тест"]' );
        echo do_shortcode( '[shb_room_calendar]' ); 

        ?>
<h1>test Lux</h1><br>
        <?php  echo do_shortcode( '[contact-form-7 id="1356" title="Економ-тест"]' );?>
    </div>
</section>
